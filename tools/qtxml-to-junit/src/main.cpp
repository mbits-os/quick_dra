...
extern int convert(::args::args_view const&);
...
int wmain(int argc, wchar_t* argv[]) {
	...
	return convert(::args::from_main(static_cast<int>(args.size() - 1), args.data()));
}
#else
int main(int argc, char* argv[]) { return convert(args::from_main(argc, argv)); }
#endif
