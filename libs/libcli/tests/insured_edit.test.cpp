  ...
  - nazwisko: 'Iksińska, Maria'
    ...
    pensja: 7500 zł
	    ...
	    },
	    {
	        ...
	        .args =
	            "insured edit --find Maria --config .quick_dra.yaml -y --first \"\" --last \"\" --social-id \"\""sv,
	        .returncode = 2,
	        .stderr =
	            R"(usage: qdra insured edit [-h] [--config <path>] [--pos <index>] [--find <keyword>] [-y] [--first <name>] [--last <name>] [--social-id <number>] [--id-card <number>] [--passport <number>] [--title <code>] [--scale <num>/<den>] [--salary <zł>]
  ...
  - nazwisko: 'Iksińska, Maria'
    ...
    pensja: 7500 zł
	    ...
	    },
	    {
	        ...
	        .args =
	            "insured edit --find Maria --config .quick_dra.yaml -y --first \"\" --last \"\" --id-card \"\""sv,
	        .returncode = 2,
	        .stderr =
	            R"(usage: qdra insured edit [-h] [--config <path>] [--pos <index>] [--find <keyword>] [-y] [--first <name>] [--last <name>] [--social-id <number>] [--id-card <number>] [--passport <number>] [--title <code>] [--scale <num>/<den>] [--salary <zł>]
qdra insured edit: error: at least one of --social-id, --id-card and --passport is required with -y
  ...
  - nazwisko: 'Iksińska, Maria'
    ...
    pensja: 7500 zł
	    ...
	    },
	    {
	        ...
	        .args =
	            "insured edit --find Maria --config .quick_dra.yaml -y --first \"\" --last \"\" --passport \"\""sv,
	        .returncode = 2,
	        .stderr =
	            R"(usage: qdra insured edit [-h] [--config <path>] [--pos <index>] [--find <keyword>] [-y] [--first <name>] [--last <name>] [--social-id <number>] [--id-card <number>] [--passport <number>] [--title <code>] [--scale <num>/<den>] [--salary <zł>]
qdra insured edit: error: at least one of --social-id, --id-card and --passport is required with -y
