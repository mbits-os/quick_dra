...
namespace quick_dra::builtin {
	...
	bool valid_last_name(std::string&& value, std::optional<std::string>& dst, bool);
	...
	namespace policies {
		template <typename T>
		static inline bool always_valid(std::string&& val, std::optional<T>& dst, bool) {
			dst = std::move(val);
			return true;
		}

		static constexpr auto first_name = "First name"_label / getters::first_name{} / valid_first_name;
		static constexpr auto last_name = "Last name"_label / getters::last_name{} / valid_last_name;
		static constexpr auto social_id = "PESEL"_label / getters::social_id{} / valid_social_id;
		static constexpr auto id_card = "ID card"_label / getters::id_card{} / valid_id_card;
		static constexpr auto passport = "Passport"_label / getters::passport{} / valid_passport;
		static constexpr auto kind = "Document kind"_label / getters::kind{} / always_valid<std::string>;
		static constexpr auto document = "Document"_label / getters::document{} / always_valid<std::string>;
