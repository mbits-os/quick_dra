...
using curl_write_callback = std::size_t (*)(char* contents, std::size_t size, std::size_t nmemb, void* userp);
#define OPTION(X)                    \
	X(str, char const*)              \
	X(long, long)                    \
	X(bool, bool)                    \
...
#define X(NAME, TYPE) CURLcode curl_easy_setopt(CURL*, CURL_##NAME##_option, TYPE);
OPTION(X)
#undef X

#define X(NAME, TYPE) CURLcode curl_easy_getinfo(CURL*, CURL_##NAME##_info, TYPE*);
INFO(X)
#undef X

CURLcode curl_easy_perform(CURL*);

#define OPT(NAME, TYPE, VALUE) static constexpr auto NAME = CURL_##TYPE##_option{VALUE};

#define NFO(NAME, TYPE, VALUE) static constexpr auto NAME = CURL_##TYPE##_info{VALUE};
